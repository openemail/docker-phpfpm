...
# Create dummy for custom overrides of openemail style
[[ ! -f /web/css/build/0081-custom-openemail.css ]] && echo '/* Autogenerated by openemail */' > /web/css/build/0081-custom-openemail.css
